...
public class TargetBlock {
    ...
    public static int DEFAULT_MAXDISTANCE = 300;
    public static double DEFAULT_VIEWHEIGHT = 1.65;
    public static double DEFAULT_CHECKDISTANCE = 0.2;
    ...
    {
        this.setValues(player.getLocation(), DEFAULT_MAXDISTANCE, DEFAULT_VIEWHEIGHT, DEFAULT_CHECKDISTANCE, null);
    }
    ...
    {
        this.setValues(loc, DEFAULT_MAXDISTANCE, 0, DEFAULT_CHECKDISTANCE, null);
    }
    ...
    {
        this.setValues(player.getLocation(), maxDistance, DEFAULT_VIEWHEIGHT, checkDistance, null);
    }
    ...
    {
        this.setValues(player.getLocation(), maxDistance, DEFAULT_VIEWHEIGHT, checkDistance, blocksToIgnore);
    }
    ...
    public TargetBlock (Player player, int maxDistance, double checkDistance, ArrayList<String> blocksToIgnore)
    {
        ...
        this.setValues(player.getLocation(), maxDistance, DEFAULT_VIEWHEIGHT, checkDistance, bti);
    }
    ...
    public static Block getTarget(Player player) {
    	return (new TargetBlock(player)).getTargetBlock();
    }
    
    public static Block getTarget(Player player, int maxdistance) {
    	return (new TargetBlock(player, maxdistance, DEFAULT_CHECKDISTANCE)).getTargetBlock();
    }
}